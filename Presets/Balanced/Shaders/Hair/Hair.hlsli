...
namespace Hair
{
	...
	// Preset: Balanced. These constants replace the custom C++ constant-buffer
	// fields from v0.5 so the addon works with the stock CommunityShaders.dll.
	static const bool TN_ADDON_ENABLED = true;
	static const float TN_ADDON_INTENSITY = 0.65;
	static const float TN_ADDON_SEPARATION = 0.70;
	static const float TN_ADDON_FINE_STRANDS = 0.55;
	static const float TN_ADDON_CAVITY_DEPTH = 0.65;
	static const float TN_ADDON_HIGHLIGHT_REDUCTION = 0.65;

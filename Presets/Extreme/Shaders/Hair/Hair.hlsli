...
namespace Hair
{
	...
	// Preset: Extreme. These constants replace the custom C++ constant-buffer
	// fields from v0.5 so the addon works with the stock CommunityShaders.dll.
	static const bool TN_ADDON_ENABLED = true;
	static const float TN_ADDON_INTENSITY = 1.35;
	static const float TN_ADDON_SEPARATION = 1.30;
	static const float TN_ADDON_FINE_STRANDS = 1.35;
	static const float TN_ADDON_CAVITY_DEPTH = 1.30;
	static const float TN_ADDON_HIGHLIGHT_REDUCTION = 1.25;
